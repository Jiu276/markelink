      ...
      <div class="container">
        <div class="footer-grid">
          <div class="footer-brand">
            ...
            <p>Expert insights on digital marketing, link building, and growth strategies for modern brands.</p>
          </div>
        ...
        <div class="footer-bottom">
          <span>&copy; ${new Date().getFullYear()} Markelink. All rights reserved.</span>
          ${renderSocialWidget()}
        </div>
      </div>
    </footer>
